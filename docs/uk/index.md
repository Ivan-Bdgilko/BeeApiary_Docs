...
Один комплект може працювати автономно як пасічні ваги BeeApiary, а разом із датчиками та застосунком утворює розумний вулик BeeApiary. Кілька таких вуликів можна об'єднати в застосунку — цифровому журналі пасіки. Різні способи доступу до даних, довготривалі нотатки, вимірювання та події створюють цілісну картину життя пасіки й допомагають бджоляру краще розуміти своїх бджіл.
...
- [Встановлення пасічних ваг BeeApiary](device/installation.md)
