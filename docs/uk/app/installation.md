...
4. Якщо плануєте отримувати дані через GSM, обов'язково надайте дозвіл на обробку SMS — без нього застосунок не зможе приймати та обробляти SMS пристрою.
    ...
    ![Дозвіл BeeApiary на обробку SMS](../../assets/uk/screenshots/app-installation-01.png){ .doc-screenshot }

5. Відкрийте перелік запущених застосунків і натисніть іконку BeeApiary.

    ![BeeApiary у переліку запущених застосунків](../../assets/uk/screenshots/app-installation-02.png){ .doc-screenshot }

6. Виберіть **Не закривати** та перевірте, що на картці застосунку з'явився замок.

    ![Опція Не закривати для BeeApiary](../../assets/uk/screenshots/app-installation-03.png){ .doc-screenshot }

    ![Закріплений у пам'яті застосунок BeeApiary](../../assets/uk/screenshots/app-installation-04.png){ .doc-screenshot }
...
1. У BeeApiary відкрийте список пристроїв і натисніть **Додати пристрій**.
    ...
    ![Список пристроїв BeeApiary](../../assets/uk/screenshots/app-installation-05.png){ .doc-screenshot }

2. Укажіть назву вулика або пасіки та номер SIM-картки вимірювального пристрою BeeApiary.

    ![Порожня форма додавання пристрою](../../assets/uk/screenshots/app-installation-06.png){ .doc-screenshot }

    ![Заповнена форма додавання пристрою](../../assets/uk/screenshots/app-installation-07.png){ .doc-screenshot }

3. Натисніть **Додати** й перевірте, що пристрій з'явився у списку.

    ![Доданий пристрій у застосунку BeeApiary](../../assets/uk/screenshots/app-installation-08.png){ .doc-screenshot }

4. Дочекайтеся першого SMS.

    ![Перші вимірювання доданого пристрою](../../assets/uk/screenshots/app-installation-13.png){ .doc-screenshot }
