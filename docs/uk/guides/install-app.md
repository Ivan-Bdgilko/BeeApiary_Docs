...
Результат: застосунок установлено. Оберіть [спосіб отримання даних із пасічних ваг BeeApiary](../system/connectivity.md) або використовуйте застосунок без ваг.
