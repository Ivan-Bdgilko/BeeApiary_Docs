...
Розклад спільний для обох номерів. У вибрані години пристрій вимірює, передає накопичені дані та переходить у режим сну. Джерело рекомендує не створювати зайвих відправлень: це витрачає заряд і GSM-трафік.

Для стислого формату в посібнику користувача рекомендовано передавання приблизно кожні чотири години, щоб не переповнювати SMS і зберегти регулярний графік.
