...
Сторінка **Додаткові налаштування** належить вебінтерфейсу пасічних ваг BeeApiary. Вона вказує, яке додаткове обладнання встановлене, і керує окремими каналами передавання даних.
...
![Додаткові налаштування у вебінтерфейсі пасічних ваг BeeApiary](../../assets/uk/system/additional-settings/device-additional-settings.jpg){ .doc-screenshot }
