...
5. After connecting, manually open `http://192.168.4.1`.
6. If the page does not open, disable mobile data or automatic switching to an Internet connection for this local session, then try again.

If one minute has elapsed, briefly hold the key against the mark again. For details, see [Local Wi-Fi](../system/local-wifi.md).
